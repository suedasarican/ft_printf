...
**Handling Types:** ft_formats acts as a router. It takes the va_list and the format character (e.g., 's', 'd', 'x') and calls the corresponding helper function.

**Counting:** Every helper function returns the number of characters printed. This total count is accumulated and returned at the end.
